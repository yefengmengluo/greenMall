...
<html>
<head>
    <title>新增供应信息${pageContext.request.contextPath}${fns:getAdminPath()}</title>
      ...
      $.ajax({
        ...
        success:function(data) {
          if(data){
            ...
            alert("新增保存成功！")
//            location.reload()
             window.location.href="${pageContext.request.contextPath}${fns:getAdminPath()}/info/createSupply";
          }
        }
      })
      $("#saveEditForm").submit()
