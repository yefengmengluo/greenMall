...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
	...
	private String loginTypeParam = DEFAULT_LOGIN_TYPE;
	...
	protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
		...
		LoginType v = null;
		if(StringUtils.isNoneEmpty(loginType) && (v = LoginType.parse(loginType))!=null){
			return new UsernamePasswordToken(username, password.toCharArray(), rememberMe, host, captcha, v);
		}else{
