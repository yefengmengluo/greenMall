...
(function ($) {
	$.extend($.validator.messages, {
		...
		fax: "请输入正确的传真号码",
		equalTo: "请再次输入相同的值",
		organizationName: "公司名称只能为5-30个汉字",
...
jQuery.validator.addMethod("username",function(value, element) {
	return this.optional(element) || /^[a-zA-Z][a-zA-Z0-9_]{4,10}$/.test(value);
},"3-20位字母开头，允许字母数字下划线");
...
jQuery.validator.addMethod("realName", function(value, element) {
    return this.optional(element) || /^([\u4e00-\u9fa5]{1,20}|[a-zA-Z\.\s]{2,30})$/.test(value);
}, "请填写正确的姓名");
...
jQuery.validator.addMethod("mobile", function(value, element) {
    ...
    return this.optional(element) || (length == 11 && /^((1[0-9]{2})+\d{8})$/.test(value));
}, "请正确填写您的手机号码");
