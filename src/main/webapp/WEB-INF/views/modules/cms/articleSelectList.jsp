		...
		$(document).ready(function() {
			$("input[name=id]").each(function(){
				...
				if (top.mainFrame.cmsMainFrame){
					articleSelect = top.mainFrame.cmsMainFrame.articleSelectList;
				}else{
					articleSelect = top.mainFrame.articleSelectList;
				}
				console.log(top)
				console.log(articleSelect)
				console.log("------")
				console.log(top.mainFrame.cmsMainFrame)
				console.log(top.mainFrame)
				if(articleSelect) {
