 ...
 */
package com.wk.p3.greenmall.modules.act.service.ext;

import java.util.List;
import java.util.Map;

import com.wk.p3.greenmall.common.utils.SpringContextHolder;
import com.wk.p3.greenmall.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.wk.p3.greenmall.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.wk.p3.greenmall.modules.sys.entity.User(null, userId)))){
