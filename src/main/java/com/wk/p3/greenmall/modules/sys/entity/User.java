...
public class User extends DataEntity<User> {
	...
	@Pattern(regexp = "^[a-zA-Z0-9_]*$",message="密码格式错误,请输入字母数字或下划线")
	private String password;// 密码
	private String no;		// 工号
	@NotNull(message="姓名不能为空")
	@Pattern(regexp = "^([\\u4e00-\\u9fa5]{1,20}|[a-zA-Z\\.\\s]{3,20})$",message="姓名只能为2-30个汉字")
	...
	@Pattern(regexp = "^((1[0-9]{2})+\\d{8})$",message="请正确填写您的手机号码")
	...
	private List<UserAddressInfo> addresses;//用户地址
