...
<form:form id="searchForm" modelAttribute="info" action="${ctx}/info/supplyDelete/" method="post" class="breadcrumb form-search">
...
<div id="infoDiv">
  <table id="contentTable" class="table table-striped table-bordered table-condensed">
    <thead><th>状态</th><th>供应单流水号</th><th>联系方式 </th><th>产品</th><th>品种</th><th>规格</th><th>数量</th><th>单价</th>
