...
<form:form id="searchForm" modelAttribute="info" action="${ctx}/info/demandChecked/" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
  <thead><tr><th></th><th>状态</th><th>采购单流水号</th><th>联系方式 </th><th>原采购内容</th><th>审核后采购内容</th><th>发布时间</th><th>备注</th><th style="width: 180px">操作</th></thead>
  <tbody>
