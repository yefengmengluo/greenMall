...
<head>
  ...
  <script type="text/javascript">
    ...
    function changeStatue(){
      ...
      var url = "${ctx}/info/supplyCheck/"
      if(selectedStatue==0){
        url = "${ctx}/info/supplyCheck/"
...
<form:form id="searchForm" modelAttribute="info" action="${ctx}/info/supplyChecked/" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
  <thead><tr><th></th><th>状态</th><th>供应单流水号</th><th>联系方式 </th><th>原供应内容</th><th>审核后供应内容</th><th>发布时间</th><th>备注</th><th   style="width: 180px">操作</th></thead>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <table class="table table-striped table-bordered table-condensed thWidth">
          ...
          <c:if test="${info.infoMessage!=null}">
            <tr>
              <th>消息</th>
              <td>
