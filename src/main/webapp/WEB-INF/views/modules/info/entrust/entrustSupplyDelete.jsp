...
<body>
<form:form id="searchForm" modelAttribute="info" action="${ctx}/info/entrustSupplyDelete/" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
  <thead><tr><th>状态</th><th>供应单流水号</th><th>联系方式 </th><th>采购内容</th><th>供应内容</th><th>状态说明</th><th>备注</th></tr></thead>
  <tbody>
