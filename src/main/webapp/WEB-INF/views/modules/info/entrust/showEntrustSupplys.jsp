...
console.log("###############")
      console.log(n)
      console.log(s)
      showEntrustSupplys($("#showDemandEntrustSupply"),'${basicId}',n,s)
      return false;
    }
  </script>--%>
</head>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
  <thead><tr><th>状态</th><th>供应产品</th><th>品种 </th><th>规范</th><th>数量</th><th>单价</th><th>联系人</th><th>联系方式</th><th>供应组织</th><th>供应地</th><th>备注</th><th>委托时间</th><th>操作</th></tr></thead>
  <tbody>
