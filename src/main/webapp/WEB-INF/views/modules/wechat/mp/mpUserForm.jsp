...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/wechat/mp/mpUser/">保存微信用户列表</a></li>
		<li class="active"><a href="${ctx}/wechat/mp/mpUser/form?id=${mpUser.id}">保存微信用户<shiro:hasPermission name="wechat:mp:mpUser:edit">${not empty mpUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="wechat:mp:mpUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="mpUser" action="${ctx}/wechat/mp/mpUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">业务主表ID：</label>
			<div class="controls">
				<sys:treeselect id="userId" name="userId" value="${mpUser.userId}" labelName="" labelValue="${mpUser.}"
		...
		<div class="control-group">
			<label class="control-label">图像URL：</label>
			<div class="controls">
				<form:input path="headimgurl" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="subscribetime" htmlEscape="false" maxlength="11" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">性别id：</label>
			<div class="controls">
				<form:input path="sexid" htmlEscape="false" maxlength="11" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="wechat:mp:mpUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
