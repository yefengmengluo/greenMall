 ...
 */
package com.wk.p3.greenmall.modules.sys.security;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		Object principalObject = getAvailablePrincipal(principals);
		Principal principal = null;
		if(principalObject==null || principalObject instanceof Principal){
...
//		private Map<String, Object> cacheMap;
		...
		public Principal(User user, boolean mobileLogin,LoginType loginType) {
			this.id = user.getId();
