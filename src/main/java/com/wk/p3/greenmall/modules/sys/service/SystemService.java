...
import com.wk.p3.greenmall.common.security.Digests;
...
import com.wk.p3.greenmall.common.utils.Encodes;
import com.wk.p3.greenmall.common.utils.StringUtils;
import com.wk.p3.greenmall.common.web.Servlets;
import com.wk.p3.greenmall.modules.sys.dao.MenuDao;
import com.wk.p3.greenmall.modules.sys.dao.RoleDao;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	//通过登陆名称和类型找用户
//	public Principal getPrincipal(String loginName,LoginType loginType){
//		return UserUtils.getPrincipalBy(loginName, loginType);
//	}

	//通过id找用户
//	public static Principal getPrincipalById(String id){
//		return UserUtils.getPrincipalBy(id);
//	}
...
//		if(principal!=null) {
//			 result = getPrincipalById(principal.toString());
//		}
//		if (principal!=null && result instanceof User){
//			return (User)result;
//		}else{
//			return null;
//		}
//	}
	 ...
	 * @return
	 */
	public long getUserByMobile(String mobile) {
		User user = new User();
	...
	/**
	 * 根据登录名获取用户
	 * @param loginName 为Principal中loginName
	 * @return
	 */
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static User currentUser() {
		Object principal =  SecurityUtils.getSubject().getPrincipal();
		SystemAuthorizingRealm.Principal result =null;
		if(principal!=null && principal instanceof SystemAuthorizingRealm.Principal) {
			result = ( SystemAuthorizingRealm.Principal)principal;
			return UserUtils.get(result.getId());
		}else{
			return null;
		}
