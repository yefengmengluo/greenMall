      ...
      <td>
        <table>
          ...
          <tr>
            ...
            <td>
              <input id="validateStartDate" name="validateStartDate" type="text" readonly="readonly" maxlength="20" style="width:157px" class="input-mini Wdate"
              ...
              <label>&nbsp;&nbsp;&nbsp;至&nbsp;&nbsp;&nbsp;</label><input id="validateEndDate" name="validateEndDate" style="width:157px" type="text" readonly="readonly" maxlength="20" class="input-mini Wdate"
