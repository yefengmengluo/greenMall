...
<body>
<form:form id="searchForm" modelAttribute="info" action="${ctx}/info/entrustDemandDelete/" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
  <thead><tr><th>状态</th><th>采购单流水号</th><th>联系方式 </th><th>采购内容</th><th>供应信息</th><th>状态说明</th><th>备注</th></thead>
  <tbody>
