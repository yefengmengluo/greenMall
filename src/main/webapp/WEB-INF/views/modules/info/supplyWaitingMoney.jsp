...
<form:form id="searchForm" modelAttribute="info" action="${ctx}/info/supplyWaitingMoney/" method="post" class="breadcrumb form-search">
...
<div id="infoDiv">
  <table id="contentTable" class="table table-striped table-bordered table-condensed">
    <thead><tr><th></th><th>状态</th><th>供应单流水号</th><th>联系方式 </th><th>产品</th><th>品种</th><th>规格</th><th>数量</th><th>单价</th>
      <th>供应组织</th><th>供应地</th>
      <th>发布时间</th>
